...
import (
	...
	"github.com/TheJubadze/OtusGolangPro/hw12_13_14_15_calendar/app/lib/storage/memory"
	...
	"github.com/TheJubadze/OtusGolangPro/hw12_13_14_15_calendar/app/service/internal/server"
	"github.com/TheJubadze/OtusGolangPro/hw12_13_14_15_calendar/app/service/internal/server/grpc"
	"github.com/TheJubadze/OtusGolangPro/hw12_13_14_15_calendar/app/service/internal/server/http"
)
...
func initStorage() (app.Storage, func(), error) {
	...
	case "sql":
		...
		if err != nil {
			return nil, nil, &ProgramError{Err: fmt.Errorf("error initializing sql storage: %w", err)}
		}
		...
		if err != nil {
			return nil, nil, &ProgramError{Err: fmt.Errorf("error migrating sql storage: %w", err)}
		}
	...
	default:
		return nil, nil, &ProgramError{Err: fmt.Errorf("error reading storage config: unknown storage type '%s'", cfg.Storage.Type)}
	}
